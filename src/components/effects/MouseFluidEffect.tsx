...
export function MouseFluidEffect() {
  ...
  useEffect(() => {
    ...
    function initFramebuffers() {
      ...
      density = {
        first: createFBO(0, textureWidth, textureHeight, internalFormat, gl.RGBA, texType, support_linear_float ? gl.LINEAR : gl.NEAREST),
        second: createFBO(1, textureWidth, textureHeight, internalFormat, gl.RGBA, texType, support_linear_float ? gl.LINEAR : gl.NEAREST),
        swap: function () {
      ...
      velocity = {
        first: createFBO(2, textureWidth, textureHeight, internalFormatRG, formatRG, texType, support_linear_float ? gl.LINEAR : gl.NEAREST),
        second: createFBO(3, textureWidth, textureHeight, internalFormatRG, formatRG, texType, support_linear_float ? gl.LINEAR : gl.NEAREST),
        swap: function () {
          const temp = this.first;
          this.first = this.second;
          this.second = temp;
      ...
      pressure = {
        first: createFBO(6, textureWidth, textureHeight, internalFormatRG, formatRG, texType, gl.NEAREST),
        second: createFBO(7, textureWidth, textureHeight, internalFormatRG, formatRG, texType, gl.NEAREST),
        swap: function () {
          const temp = this.first;
          this.first = this.second;
          this.second = temp;
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      pointers[0].dx = ((e as any).offsetX - pointers[0].x) * 10.0;
      pointers[0].dy = ((e as any).offsetY - pointers[0].y) * 10.0;
      pointers[0].x = (e as any).offsetX;
    ...
    const update = () => {
      ...
      if (splatStack.length > 0) {
        for (let m = 0; m < (splatStack.pop() || 0); m++) {
