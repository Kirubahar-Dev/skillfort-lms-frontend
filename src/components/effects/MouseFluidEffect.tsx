...
export function MouseFluidEffect() {
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      let texType = isWebGL2 ? gl.HALF_FLOAT : (halfFloat as any).HALF_FLOAT_OES;
    ...
    let textureWidth = 0;
    let textureHeight = 0;
    let density: any = void 0;
    let velocity: any = void 0;
    let divergence: any = void 0;
    let curl: any = void 0;
    let pressure: any = void 0;
